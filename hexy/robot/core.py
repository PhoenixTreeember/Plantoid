...
joint_properties = {
    ...
    'RFH': (6, 100, 500), 'RFK': (7, 100, 500), 'RFA': (8, 100, 500),
    'RMH': (6, 100, 500), 'RMK': (7, 100, 500), 'RMA': (8, 100, 500),
    'RBH': (3, 100, 500), 'RBK': (4, 100, 500), 'RBA': (5, 100, 500),
    'LFH': (3, 100, 500), 'LFK': (4, 100, 500), 'LFA': (5, 100, 500),
    'LMH': (0, 100, 500), 'LMK': (1, 100, 500), 'LMA': (2, 100, 500),
    'LBH': (0, 100, 500), 'LBK': (1, 100, 500), 'LBA': (2, 100, 500),
    'N': (9, 100, 500)
}
